...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'turbofilms@helixhaven.onmicrosoft.com',
  ...
  baseDirectory: process.env.BASE_DIRECTORY || '/TurboFilms',
